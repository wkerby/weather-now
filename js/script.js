...
var currentWeatherTypeEl = $("#current-weather-type")
...
var out1WeatherTypeEl = $("#out-1-weather-type");
...
var out2WeatherTypeEl = $("#out-2-weather-type");
...
var out3WeatherTypeEl = $("#out-3-weather-type");
...
var out4WeatherTypeEl = $("#out-4-weather-type");
...
var out5WeatherTypeEl = $("#out-5-weather-type");
...
var forecastWeatherTypes = [out1WeatherTypeEl, out2WeatherTypeEl, out3WeatherTypeEl, out4WeatherTypeEl, out5WeatherTypeEl];
...
function getWeather(key, weathData) { //parameter passed in getWeather is the object that is returned from getLatLon
    ...
    fetch(requestUrl)
        ...
        .then(function (data) {
            ...
            currentWeatherTypeEl.text(currentWeather);
...
function postWeatherOut(data) {
    ...
    for (var i = 1; i < forecastDates.length + 1; i++) {
        ...
        forecastWeatherTypes[i - 1].text(outWeather);
